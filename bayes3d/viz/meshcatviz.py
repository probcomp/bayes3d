...
def show_trimesh(channel, mesh, color=None, wireframe=False, opacity=1.0):
    ...
    material = g.MeshLambertMaterial(
        color=int(rgb2hex(color)[1:], 16), wireframe=wireframe, opacity=opacity
    )
