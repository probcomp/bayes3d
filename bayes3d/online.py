...
def run_occlusion_search(image, renderer, obj_idx, timestep=1):
    ...
    enumeration_viz = j.viz.resize_image(bayes3d.viz.get_depth_image(all_images_overlayed[:,:,2], max=intrinsics.far), image.intrinsics.height, image.intrinsics.width)
