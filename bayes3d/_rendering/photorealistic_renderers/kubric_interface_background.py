...
def render_many(mesh_paths, poses, intrinsics, scaling_factor=1.0, lighting=5.0, tabletop_scaling_factor=[1,1,1]):
    ...
    np.savez("/tmp/blenderproc_kubric.npz", 
        ...
        tabletop_scaling_factor=tabletop_scaling_factor,
    ...
    command_string2 = f""" kubricdockerhub/kubruntu /usr/bin/python3 {path}/photorealistic_renderers/_kubric_exec_parallel_background.py"""
