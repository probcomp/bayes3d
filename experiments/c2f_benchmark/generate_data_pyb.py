...
obj, obj_dims = jax3dp3.pybullet_utils.add_mesh(mesh_path)
...
jax3dp3.pybullet_utils.set_pose_wrapped(obj, jax3dp3.distributions.gaussian_vmf(jax.random.PRNGKey(1), 0.00001, 0.001))

rgb,depth,seg = jax3dp3.pybullet_utils.capture_image(cam_pose, intrinsics.height, intrinsics.width, intrinsics.fx, intrinsics.fy, intrinsics.cx, intrinsics.cy, intrinsics.near, intrinsics.far)
...
jax3dp3.pybullet_utils.remove_body(pybullet_objects[-1])
