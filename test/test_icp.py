...
transform = b.utils.find_least_squares_transform_between_clouds(cloud, cloud_transformed)
...
pose2 = pose @  b.distributions.gaussian_vmf_zero_mean(jax.random.PRNGKey(5), 0.05,1000.0)
...
transform = b.utils.find_least_squares_transform_between_clouds(img1[mask,:], img2[mask, :])
