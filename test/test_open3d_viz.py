...
# j.get_rgb_image(viz.capture_image(rgbd.intrinsics, np.eye(4))).save("test_open3d_viz_1.png")
...
# j.get_rgb_image(viz.capture_image(rgbd.intrinsics, np.eye(4))).save("test_open3d_viz_2.png")
...
# j.get_rgb_image(viz.capture_image(viz_intrinsics, np.eye(4))).save("test_open3d_viz_3.png")
