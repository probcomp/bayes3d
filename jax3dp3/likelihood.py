...
def gaussian_mixture_image(
    ...
    probs = gausssian_mixture_per_pixel(
...
def threedp3_likelihood(
    ...
    probs = gaussian_mixture_image(observed_xyz, rendered_xyz, rendered_seg, r_array)
    probs_with_outlier_model = probs * (1.0 - outlier_prob)  + outlier_prob / outlier_volume
    return jnp.log(probs_with_outlier_model).sum()  

threedp3_likelihood_parallel = jax.vmap(threedp3_likelihood, in_axes=(None, 0, 0, None, None, None))
